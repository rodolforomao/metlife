...
<div class="panel panel-default">
    <div class="panel-heading">
        Add/Modify Dadoscadastrai    </div>

    <div class="panel-body">
                
        <form action="{{ url('/dadoscadastrais'.( isset($model) ? "/" . $model->id : "")) }}" method="POST" class="form-horizontal">
            {{ csrf_field() }}
            ...
            @endif
                ...
                <div class="col-sm-6">
                    <input type="text" name="estadocivil" id="estadocivil" class="form-control" value="{{$model['estadocivil'] or ''}}">
                </div>
            </div>
                                                                                                <div class="form-group">
                <label for="enderecoresidencial" class="col-sm-3 control-label">Enderecoresidencial</label>
                <div class="col-sm-6">
                    <input type="text" name="enderecoresidencial" id="enderecoresidencial" class="form-control" value="{{$model['enderecoresidencial'] or ''}}">
                </div>
            </div>
                                                                                                <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="celular" id="celular" class="form-control" value="{{$model['celular'] or ''}}">
                </div>
            </div>
