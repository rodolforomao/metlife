...
<div class="panel panel-default">
    <div class="panel-heading">
        Add/Modify Emprestimounitario    </div>

    <div class="panel-body">
                
        <form action="{{ url('/emprestimounitarios'.( isset($model) ? "/" . $model->id : "")) }}" method="POST" class="form-horizontal">
            {{ csrf_field() }}
            ...
            @endif
                ...
                <div class="col-sm-6">
                    <input type="text" name="saldodevedor" id="saldodevedor" class="form-control" value="{{$model['saldodevedor'] or ''}}">
                </div>
            </div>
                                                                                                <div class="form-group">
                <label for="possuiseguro" class="col-sm-3 control-label">Possuiseguro</label>
                <div class="col-sm-6">
                    <input type="text" name="possuiseguro" id="possuiseguro" class="form-control" value="{{$model['possuiseguro'] or ''}}">
                </div>
            </div>
                                                                                                <div class="form-group">
                <label for="parcelamensal" class="col-sm-3 control-label">Parcelamensal</label>
                <div class="col-sm-6">
                    <input type="text" name="parcelamensal" id="parcelamensal" class="form-control" value="{{$model['parcelamensal'] or ''}}">
                </div>
            </div>
                                                                                                <div class="form-group">
                <label for="prazoresidual" class="col-sm-3 control-label">Prazoresidual</label>
                <div class="col-sm-6">
                    <input type="text" name="prazoresidual" id="prazoresidual" class="form-control" value="{{$model['prazoresidual'] or ''}}">
                </div>
            </div>
                                                                                                <div class="form-group">
                <label for="saldodevedordescoberto" class="col-sm-3 control-label">Saldodevedordescoberto</label>
                <div class="col-sm-6">
                    <input type="text" name="saldodevedordescoberto" id="saldodevedordescoberto" class="form-control" value="{{$model['saldodevedordescoberto'] or ''}}">
                </div>
            </div>
