...
<div class="panel panel-default">
    <div class="panel-heading">
        Add/Modify Educacao    </div>

    <div class="panel-body">
                
        <form action="{{ url('/educacaos'.( isset($model) ? "/" . $model->id : "")) }}" method="POST" class="form-horizontal">
            {{ csrf_field() }}
            ...
            @endif
                ...
                <div class="col-sm-6">
                    <input type="text" name="anos2" id="anos2" class="form-control" value="{{$model['anos2'] or ''}}">
                </div>
            </div>
                                                                                                <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="anos3" id="anos3" class="form-control" value="{{$model['anos3'] or ''}}">
                </div>
            </div>
                                                                                                <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="anos4" id="anos4" class="form-control" value="{{$model['anos4'] or ''}}">
                </div>
            </div>
                                                                                                <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="anos1" id="anos1" class="form-control" value="{{$model['anos1'] or ''}}">
                </div>
            </div>
                                                                                                <div class="form-group">
