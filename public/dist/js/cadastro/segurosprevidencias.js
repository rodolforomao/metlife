            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        html += "               </div>";
                        html += "               <input type='text' class='form-control' name='renda_estimada[]' placeholder='Saldo Acumulado' value='" + data[i].saldo_acumulado + "'";
                        ...
                        html += "                   <span class='input-group-text'>R$</span>";
                        html += "               </div>";
                        html += "               <input type='text' class='form-control' name='renda_estimada[]' placeholder='Renda Estimada' value='" + data[i].renda_estimada + "'";
                        html += "                   onkeydown='FormataMoeda(this, 20, event)' onkeypress='return maskKeyPress(event)'>";
                        html += "           </div>";
                        html += "       </div>";
                        html += "   </div>";
