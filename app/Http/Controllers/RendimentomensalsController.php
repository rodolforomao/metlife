...
class RendimentomensalsController extends Controller
{
  ...
  public function grid(Request $request)
  {
    ...
    //------------------------------------
    $orderby = "";
    $columns = array('id','created_at','updated_at','idCliente','tipoFamiliar','remendimentosmensal','outrasrendas','declaracaodeir',);
  ...
  if($request->id > 0) { $rendimentomensal = Rendimentomensal::findOrFail($request->id); }
    ...
    $rendimentomensal->id = $request->id?:0;
      ...
      $rendimentomensal->tipoFamiliar = $request->tipoFamiliar;
